#ifndef __SHT30_DIS_H__
#define __SHT30_DIS_H__

#include "stm32f10x.h"
#include "delay.h"

  #define IIC_SCL_H       GPIO_SetBits(GPIOB, GPIO_Pin_7);
  #define IIC_SCL_L       GPIO_ResetBits(GPIOB, GPIO_Pin_7);
  #define IIC_SDA_H       GPIO_SetBits(GPIOB, GPIO_Pin_6); 
  #define IIC_SDA_L       GPIO_ResetBits(GPIOB, GPIO_Pin_6); 
  ...
  //??????
//  #define  TEM_CHEAK_VALUE           3//?????9??????1????3  2 13
//  #define  RH_CHEAK_VALUE            10
  #define  TEM_CHEAK_VALUE           0//2
  #define  RH_CHEAK_VALUE            0//13
...
extern float RhValue;
  ...
  extern void sht30_dis_init(void);
  extern void SHT_GetValue(void);
#endif 
